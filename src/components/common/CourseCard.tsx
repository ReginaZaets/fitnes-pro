...
export const CourseCard = ({ course, progress }: CourseCardProps) => {
  ...
  return (
    <div className="cursor-pointer w-[360px] min-h-[501px] flex flex-col justify-start font-normal text-[16px] leading-[17px] bg-white gap-[10px] mt-[24px] rounded-[30px] shadow-lg ">
